...
#if defined STM32F407xx													//这个在keil的魔术棒中已经宏定义了, 不同的型号生成不同的宏定义, 

#include "Balance/MPU6050/mpu6050.h"														//mpu6050的底层驱动, 符合DMP下面的 i2c_write,i2c_read 两函数
#include "main.h"													//芯片型号的头文件
#include "i2c.h"																//HAL库用到的i2c接口
//#include "stm32f4xx_hal.h"											//HAL库没有为专门延时单独写个库, Hal_Delay 在stm32f4xx_hal.h中
